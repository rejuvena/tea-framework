...
namespace TeaFramework.Impl.Utility
{
    partial class Reflection
    {
        ...
        {
            public override string ToString() => Type.FullName + "." + MemberName;
        }
        ...
        public static object? InvokeFieldGetter(Type type, string fieldName, object? instance)
        {
            ...
            {
                if (instance is null)
                    throw new ReflectionInvocationException("Attempted to get value of instanced field w/o instance.");
            ...
            if (staticGetter is not null)
            {
                if (instance is not null)
                    throw new ReflectionInvocationException("Attempted to get value of static field w/ instance.");
        ...
        public static void InvokeFieldSetter(Type type, string fieldName, object? instance, object? value)
        {
            ...
            {
                if (instance is null)
                    throw new ReflectionInvocationException("Attempted to set value of instanced field w/o instance.");
            ...
            {
                if (instance is not null)
                    throw new ReflectionInvocationException("Attempted to set value of static field w/ instance.");
        ...
        {
            if (FieldGetters.ContainsKey(id) || StaticFieldGetters.ContainsKey(id))
                return;
        ...
        {
            if (FieldSetters.ContainsKey(id) || StaticFieldSetters.ContainsKey(id))
                return;
        ...
        public static object? InvokePropertyGetter(Type type, string propertyName, object? instance)
        {
            ...
            {
                if (instance is null)
                    throw new ReflectionInvocationException("Attempted to get value of instanced property w/o instance.");
            ...
            {
                if (instance is not null)
                    throw new ReflectionInvocationException("Attempted to get value of static property w/ instance.");
        ...
        public static void InvokePropertySetter(Type type, string propertyName, object? instance, object? value)
        {
            ...
            {
                if (instance is null)
                    throw new ReflectionInvocationException("Attempted to set value of instanced property w/o instance.");
            ...
            {
                if (instance is not null)
                    throw new ReflectionInvocationException("Attempted to set value of static property w/ instance.");
        ...
        {
            if (PropertyGetters.ContainsKey(id) || StaticPropertyGetters.ContainsKey(id))
                return;
        ...
        {
            if (PropertySetters.ContainsKey(id) || StaticPropertySetters.ContainsKey(id))
                return;
    ...
    public static class Reflection<T>
    {
        public static object? InvokeFieldGetter(string fieldName, object? instance) =>
            Reflection.InvokeFieldGetter(typeof(T), fieldName, instance);
        ...
        public static object? InvokePropertyGetter(string fieldName, object? instance) =>
            Reflection.InvokePropertyGetter(typeof(T), fieldName, instance);
