...
namespace TeaFramework.Features.Utility
{
    ...
    public static partial class Reflection
    {
        ...
        public static T? InvokeUnderlyingMethod<T>(
            ...
            object? instance,
            object?[]? args
        ) => (T?)field.InvokeUnderlyingMethod(method, signature, genericCount, instance, args);
        ...
        public static T? InvokeUnderlyingMethod<T>(
            ...
            object? instance,
            object?[]? args
        ) => (T?)property.InvokeUnderlyingMethod(method, signature, genericCount, instance, args);
