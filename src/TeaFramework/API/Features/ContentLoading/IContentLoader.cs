...
namespace TeaFramework.API.Features.ContentLoading
{
    ...
    /// </summary>
    /// <remarks>
    ///     There should only be one content loader per loadable type. Collisions are not supported and are not planned to be.
    ///     <br />
    ///     You may override content loaders used by Tea Framework if you so wish. <br />
    ///     Each mod uses their own defined content loaders. If you are making a library, properly inform modders to use your
    ///     content loaders.
    /// </remarks>
